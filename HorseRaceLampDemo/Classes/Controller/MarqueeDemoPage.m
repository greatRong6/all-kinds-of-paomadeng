...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    headLine2.messageArray = @[@"郑爽胡彦斌约会，瘦成一道闪电",@"范冰冰李晨回家过年，年夜饭朴素",@"2、伦纳德死亡缠绕詹姆斯，马刺大胜骑士",@"5、天猫的双十一，然而并没卵用"];
    ...
    [headLine2 changeTapMarqueeAction:^(NSInteger index) {
        
        NSLog(@"你点击了第 %ld 个button！内容：%@", index, headLine2.messageArray[index]);
